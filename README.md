...
- Toronto Neighbourhood Boundaries — [City of Toronto Open Data](https://open.toronto.ca/dataset/neighbourhoods/)
- CaféTO Permit Locations — [City of Toronto Open Data](https://open.toronto.ca/dataset/cafeto/)
- 2021 Census Neighbourhood Profiles — [City of Toronto Open Data](https://open.toronto.ca/dataset/neighbourhood-profiles/)
...
| File | Description |
|------|-------------|
| [`GGR376_Group15_Proposal_Analysis_.ipynb`](GGR376_Group15_Proposal_Analysis_.ipynb) | Main analysis notebook (GeoPandas, PySAL, SKATER) |
| [`Project_Proposal-group15.docx`](Project_Proposal-group15.docx) | Original project proposal document |
...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1GHHWURdU2tpAGdzpULWZb1XOAVpZsI3m)# GGR376H5 — CaféTO Spatial Analysis
